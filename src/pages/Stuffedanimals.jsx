...
export default function Stuffedanimals() {
        ...
        <div className="cont-main">
            <div className="container main-con">
                <div className="cont-main-top">
                    <div className="words">
                            <h3>tuffed Animals</h3>
                            <div className="nr">
                                <a href="/catalog" >All Toys</a>
                                <a href="/catalog/wooden-toys" >Wooden Toys</a>
                                <a href="/catalog/stuffed-animals" className='xz'>Stuffed Animals</a>
                            </div>
